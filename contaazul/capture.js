...
async function main() {
    console.log('=== CAPTURADOR DE SESSÃO COM PLAYWRIGHT - CONTA AZUL ===\n');

    const targetUrl = 'https://mais.contaazul.com/#/login';

    console.log(`Iniciando o navegador chromium headed...`);
    ...
    console.log(' 3. Quando estiver logado e no Dashboard do Conta Azul, volte aqui.');
    ...
    console.log(`✓ Estado completo salvo em: ${statePath}`);

    // 4. Montar o arquivo .env
    let envContent = `# Configurações da sessão do Conta Azul capturada em ${new Date().toISOString()}\n`;
